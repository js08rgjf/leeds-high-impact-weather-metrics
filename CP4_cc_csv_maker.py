...
########################################################################################################################
	...
	if pressure_level != -500:
		np.savetxt('CP4_CC_month_'+str(m)+'_'+str(percentile)+'th_percentile_'+str(variable_STASH)+'_'+str(pressure_level)+'hPa_daily_'+str(measure)+'_lon_'+str(xmin)+'_'+str(xmax)+'_lat_'+str(ymin)+'_'+str(ymax)+'.csv', rainfall, delimiter = ',')

	else:
		np.savetxt('CP4_CC_month_'+str(m)+'_'+str(percentile)+'th_percentile_'+str(variable_STASH)+'_single_level_daily_'+str(measure)+'_lon_'+str(xmin)+'_'+str(xmax)+'_lat_'+str(ymin)+'_'+str(ymax)+'.csv', rainfall, delimiter = ',')
	np.savetxt("CP4_longitudes_"+str(xmin)+"_"+str(xmax)+".csv", lons, delimiter = ',')
	np.savetxt("CP4_latitudes_"+str(xmin)+"_"+str(xmax)+".csv", lats, delimiter = ',')
